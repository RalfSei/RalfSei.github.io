---
layout: default
title: "Quishing – Gefahr durch manipulierte QR-Codes"
permalink: /quishing/
nav: true
nav_section: "Datenschutz"
nav_order: 52
summary: "Was ist Quishing (QR-Phishing), wie funktioniert es – und wie schützt man sich davor?"
show_on_home: true
---
...
- Plakaten und Flyern  
- Restaurantkarten  
- Lieferdienst-Aufklebern  
- Öffentlichen Informationssäulen  
...
- „Bestätigen Sie Ihr Paket“  
- „Ihr Konto wurde eingeschränkt – bitte verifizieren“  
- „Neues wichtiges Dokument – jetzt mit QR-Code öffnen“
...
- **Datendiebstahl** (Logins, Passwörter, TANs)  
- **Missbrauch von Online-Konten**  
...
- Sieht der QR-Code sauber gedruckt aus oder wurde er sichtbar überklebt?  
- Passt der QR-Code zum Kontext (seriöses Medium, offizielles Plakat)?  

#### 2. Vorsicht bei QR-Codes in E-Mails

- Keine QR-Codes aus **unbekannten** oder **unerwarteten** E-Mails scannen.  
- Lieber direkt die echte Website öffnen (z. B. Bank, DHL, Telekom).
...
- Gibt es verdächtige Schreibfehler (z. B. `micros0ft.com`)?  
...
- Mitarbeitende über **Quishing** und **Social Engineering** sensibilisieren  
- Interne Richtlinien für die Nutzung und Gestaltung von QR-Codes definieren  
